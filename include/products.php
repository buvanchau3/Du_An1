...
<body class="bg-gray-100">
    <div class="container mx-auto p-6">
        <h1 id="title-product" class="text-3xl font-bold text-center mb-8">SẢN PHẨM</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Card -->
            <div class="bg-white rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <div class="relative">
                    <a href="details.php">
                    <img class="w-100 h-100 object-cover" src="../image/đồ-nữ-1.png" alt="Sản phẩm">
        ...
        <h1 id="title-product-nam" class="text-3xl font-bold text-center mb-8" style="margin-top: 30px">SẢN PHẨM NAM</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Card -->
            <div class="bg-white rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <div class="relative">
                    <a href="details.php">
                    <img class="w-100 h-100 object-cover" src="../image/đồ-nam-1.png" alt="Sản phẩm">
        ...
        <h1 id="title-product-nu" class="text-3xl font-bold text-center mb-8" style="margin-top: 30px">SẢN PHẨM NỮ</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Card -->
            <div class="bg-white rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <div class="relative">
        ...
        <h1 id="title-product-be-gai" class="text-3xl font-bold text-center mb-8" style="margin-top: 30px">SẢN PHẨM BÉ GÁI</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Card -->
            <div class="bg-white rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <div class="relative">
                    <a href="details.php">
                    <img class="w-100 h-100 object-cover" src="../image/bé-gai-1.png" alt="Sản phẩm">
        ...
        <h1 id="title-product-be-trai" class="text-3xl font-bold text-center mb-8" style="margin-top: 30px">SẢN PHẨM BÉ TRAI</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <!-- Product Card -->
            <div class="bg-white rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <div class="relative">
                    <a href="details.php">
                    <img class="w-100 h-100 object-cover" src="../image/bé-trai-1.png" alt="Sản phẩm">
