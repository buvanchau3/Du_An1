...
<body>
        ...
        <footer class="text-center text-lg-start bg-body-tertiary text-muted">
                ...
                <div class="container text-center text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#!" class="text-reset">Với cộng đồng</a>
                            </p>
                            <p>
                                <a href="#!" class="text-reset">Hệ thóng của hàng</a>
                            </p>
                            <p>
                        ...
                        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p>
                                <a href="#!" class="text-reset">Chính sách bảo mật thông tin KH</a>
                            </p>
                        </div>
                        <!-- Grid column -->
            ...
            <!-- Copyright -->
            <div class="text-center p-4 dropdown-divider" style="font-size: 14px; font-weight: 700; color: #111;" >
                © 2024 Copyright:
                <a class="text-reset fw-bold" href="#">Beautyfful</a>
            </div>
            <!-- Copyright -->
        </footer>
        <!-- Footer -->
